...
Let us experiment with interpolating between Projected $\tilde{R}$ and $vv^{\top}$
Consider $R = \lambda \tilde{R} + (1-\lambda) vv^{\top}$ and set $diag(R) = 1$. We find it helps controlling the residual a little bit.
