...
+ <span style="color:green; font-size:20px;">■</span> for case where the TSVD improved the power and reduce the FDR compare to out-sample LD.

+ <span style="color:green; font-size:20px;">●</span> for case where the TSVD improved the power but increased the FDR compare to out-sample LD.

+ <span style="color:green; font-size:20px;">▲</span> for case where the TSVD maintained the same power but reduced the FDR compare to out-sample LD.
